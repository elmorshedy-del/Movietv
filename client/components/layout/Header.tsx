  ...
  return (
    <header className="sticky top-0 z-50 h-[62px] border-b border-white/[0.035] bg-[#100b0c]/95 backdrop-blur-md">
      <div className="mx-auto flex h-full w-full max-w-[1223px] items-center px-5 sm:px-7">
        <Link
          to="/"
          className="mr-5 flex shrink-0 items-center gap-1.5 font-script text-[32px] leading-none text-[#f5e7df] sm:ml-[6px] sm:mr-[42px] sm:text-[34px]"
        >
          For You
        ...
        <div className="ml-auto flex h-full shrink-0 items-center">
          ...
          >
            <span className="grid h-9 w-9 place-items-center rounded-full bg-[radial-gradient(circle_at_35%_28%,#f8bcc4_0%,#d85f72_42%,#5b2130_100%)] ring-1 ring-white/15 shadow-[0_0_18px_rgba(225,93,115,.16)]">
