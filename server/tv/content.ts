...
export const CHANNELS: Record<string, ChannelDefinition> = {
  ...
  discovery: channel("discovery", "Discovery", ["[Vip]OSN_Discovery_FHD", "[Vip]OSN_Discovery_Channel_HD", "DiscoveryHD", "Discovery [US]"]),
  ...
  natGeo: channel("nat-geo", "National Geographic", ["Nat Geo [US]", "National Geo AD [AR]", "Nat. Geo. AD"]),
  ...
  dmc: channel("dmc", "DMC", ["DMC [EG]", "DMC"]),
  dmcDrama: channel("dmc-drama", "DMC Drama", ["DMC DRAMA [EG]", "DMC DRAMA"]),
  onE: channel("on-e", "ON", ["ON E [EG]", "ON E"]),
